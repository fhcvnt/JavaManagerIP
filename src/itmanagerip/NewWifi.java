...
public class NewWifi {
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(NewWifi.class, "/itmanagerip/Icon/IP64.png"));
		shell.setSize(807, 436);
		shell.setText("New wifi");
		...
		btnSave.setImage(SWTResourceManager.getImage(NewWifi.class, "/itmanagerip/Icon/button/save 30.png"));
		...
		btnCancel.setImage(SWTResourceManager.getImage(NewWifi.class, "/itmanagerip/Icon/button/cancel.png"));
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					...
					if (validateIP(textIPLAN.getText()) || textIPLAN.getText().isEmpty()) {
						if (!textPass24.getText().isEmpty() && !textPassword.getText().isEmpty() && pass24ghz.isEmpty()
							...
							try {
								String insert = "INSERT INTO Wifi ( Code,Manufacturer,Floors,WifiName24GHz,Pass24GHz,WifiName5GHz,Pass5GHz,IPLAN,LINK,Username,Pass,UserUpdate) VALUES  ( '"
										+ textID.getText() + "','" + textManufacturer.getText() + "','"
										+ textFloor.getText() + "',N'" + textWifiname24.getText() + "','"
										+ textPass24.getText() + "', N'" + textWifiname5.getText() + "','"
										+ textPass5.getText() + "','" + textIPLAN.getText() + "','" + textLink.getText()
	...
	// **********************************************************************************************************************
	// Lay du lieu ban dau
	public void setDataDefault(String sothe, String ip, String toanha) {
		this.sothe = sothe;
		try {
			connect = new ConnectSQL();
			connect.setConnection();
