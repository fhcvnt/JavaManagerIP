...
public class IPList1366x768 {
	...
	public static void main(String[] args) {
		try {
			IPList1366x768 window = new IPList1366x768();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void createContentsShell() {
		shell = new Shell();
		shell.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/IP64.png"));
		shell.setSize(1386, 772);
	...
	protected void createContents(Composite composite, Shell shell, int ngonngu) {
		...
		lbsothe.setBounds(10, 13, 60, 25);
		lbsothe.setText("Số thẻ");
		lbsothe.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));

		textsothe = new Text(composite, SWT.BORDER);
		textsothe.setBounds(76, 13, 78, 25);
		textsothe.setTextLimit(12);
		textsothe.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		...
		lbhoten.setBounds(160, 13, 68, 25);
		lbhoten.setText("Họ tên");
		lbhoten.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));

		texthoten = new Text(composite, SWT.BORDER);
		texthoten.setBounds(234, 13, 125, 25);
		texthoten.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		...
		lbdonvi.setBounds(365, 13, 92, 25);
		lbdonvi.setText("Đơn vị");
		lbdonvi.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));

		textdonvi = new Text(composite, SWT.BORDER);
		textdonvi.setBounds(463, 13, 132, 25);
		textdonvi.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		...
		lbtoanha.setBounds(601, 13, 94, 25);
		lbtoanha.setText("Tòa nhà");
		lbtoanha.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));

		texttoanha = new Text(composite, SWT.BORDER);
		texttoanha.setBounds(701, 13, 78, 25);
		texttoanha.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		texttoanha.setBackground(SWTResourceManager.getColor(SWT.COLOR_INFO_BACKGROUND));

		btnthem = new Button(composite, SWT.NONE);
		btnthem.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/add.png"));
		btnthem.setBounds(785, 13, 92, 27);
		btnthem.setText("Thêm");
		btnthem.setForeground(SWTResourceManager.getColor(SWT.COLOR_BLUE));
		btnthem.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));

		btnsua = new Button(composite, SWT.NONE);
		btnsua.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/edit.png"));
		btnsua.setBounds(883, 12, 78, 27);
		btnsua.setText("Sửa");
		btnsua.setForeground(SWTResourceManager.getColor(SWT.COLOR_DARK_GREEN));
		btnsua.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));

		btnxoa = new Button(composite, SWT.NONE);
		btnxoa.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/delete20.png"));
		btnxoa.setBounds(967, 12, 94, 27);
		btnxoa.setText("Xóa");
		btnxoa.setForeground(SWTResourceManager.getColor(SWT.COLOR_RED));
		btnxoa.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));

		btnExcel = new Button(composite, SWT.NONE);
		btnExcel.setText("Excel");
		btnExcel.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/excel25.png"));
		btnExcel.setForeground(SWTResourceManager.getColor(SWT.COLOR_DARK_GREEN));
		btnExcel.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));
		btnExcel.setBounds(1067, 12, 92, 27);

		btnLuu = new Button(composite, SWT.NONE);
		btnLuu.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/save25.png"));
		btnLuu.setBounds(1165, 12, 78, 27);
		btnLuu.setText("Lưu");
		btnLuu.setForeground(SWTResourceManager.getColor(SWT.COLOR_BLUE));
		btnLuu.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));

		btnHuy = new Button(composite, SWT.NONE);
		btnHuy.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/cancel20.png"));
		btnHuy.setBounds(1249, 12, 92, 27);
		btnHuy.setText("Hủy");
		btnHuy.setForeground(SWTResourceManager.getColor(SWT.COLOR_RED));
		btnHuy.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));

		CLabel lbIP = new CLabel(composite, SWT.RIGHT);
		lbIP.setText("IP");
		lbIP.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		lbIP.setBounds(20, 44, 44, 25);

		textIP = new Text(composite, SWT.BORDER);
		textIP.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		textIP.setBackground(SWTResourceManager.getColor(224, 255, 255));
		textIP.setBounds(76, 44, 78, 25);

		CLabel lbhedieuhanh = new CLabel(composite, SWT.RIGHT);
		lbhedieuhanh.setText("Hệ điều hành");
		lbhedieuhanh.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		lbhedieuhanh.setBounds(160, 44, 132, 25);

		texthedieuhanh = new Text(composite, SWT.BORDER);
		texthedieuhanh.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		texthedieuhanh.setBackground(SWTResourceManager.getColor(224, 255, 255));
		texthedieuhanh.setBounds(298, 43, 102, 25);

		CLabel lboffice = new CLabel(composite, SWT.RIGHT);
		lboffice.setText("Office");
		lboffice.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		lboffice.setBounds(406, 44, 60, 25);

		textoffice = new Text(composite, SWT.BORDER);
		textoffice.setFont(SWTResourceManager.getFont("Times New Roman", 13, SWT.NORMAL));
		textoffice.setBackground(SWTResourceManager.getColor(224, 255, 255));
		textoffice.setBounds(473, 44, 102, 25);

		CLabel lbLoaimay = new CLabel(composite, SWT.RIGHT);
		lbLoaimay.setText("Loại máy");
		lbLoaimay.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		lbLoaimay.setBounds(581, 44, 102, 25);

		textloaimay = new Text(composite, SWT.BORDER);
		textloaimay.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		textloaimay.setBackground(SWTResourceManager.getColor(224, 255, 255));
		textloaimay.setBounds(688, 44, 107, 25);

		CLabel lbEmail = new CLabel(composite, SWT.RIGHT);
		lbEmail.setText("Email");
		lbEmail.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		lbEmail.setBounds(801, 44, 60, 25);

		textEmail = new Text(composite, SWT.BORDER);
		textEmail.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.NORMAL));
		textEmail.setBackground(SWTResourceManager.getColor(224, 255, 255));
		textEmail.setBounds(867, 44, 112, 25);

		btntimkiem = new Button(composite, SWT.NONE);
		btntimkiem.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/search.png"));
		btntimkiem.setText("Tìm kiếm");
		btntimkiem.setForeground(SWTResourceManager.getColor(SWT.COLOR_DARK_YELLOW));
		btntimkiem.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));
		btntimkiem.setBounds(985, 42, 125, 30);

		btnGetIP = new Button(composite, SWT.NONE);
		btnGetIP.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/get ip25.png"));
		btnGetIP.setText("Get IP");
		btnGetIP.setForeground(SWTResourceManager.getColor(SWT.COLOR_BLUE));
		btnGetIP.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));
		btnGetIP.setBounds(1116, 41, 107, 30);

		btnDetail = new Button(composite, SWT.NONE);
		btnDetail.setImage(SWTResourceManager.getImage(IPList1366x768.class, "/itmanagerip/Icon/button/detail30.jpg"));
		btnDetail.setForeground(SWTResourceManager.getColor(SWT.COLOR_DARK_CYAN));
		btnDetail.setFont(SWTResourceManager.getFont("Times New Roman", 12, SWT.BOLD));
		btnDetail.setBounds(1229, 41, 112, 30);
		btnDetail.setText("Detail");

		table = new Table(composite, SWT.BORDER | SWT.MULTI | SWT.FULL_SELECTION | SWT.VIRTUAL);
		table.setLocation(10, 75);
		table.setSize(1344, 630);
		...
		table.setFont(SWTResourceManager.getFont("Times New Roman", 11, SWT.NORMAL));
