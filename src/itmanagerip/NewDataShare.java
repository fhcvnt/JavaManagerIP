...
public class NewDataShare {
	...
	public static void main(String[] args) {
		try {
			NewDataShare window = new NewDataShare();
			window.open();
			System.exit(0);
		} catch (Exception e) {
			e.printStackTrace();
	...
	protected void createContents() {
		...
		shell.setText("New data share");
		shell.setImage(SWTResourceManager.getImage(NewDataShare.class, "/itmanagerip/Icon/IP64.png"));
		...
		btnSave.setImage(SWTResourceManager.getImage(NewDataShare.class, "/itmanagerip/Icon/button/save 30.png"));
		...
		lbImage.setBackground(
				SWTResourceManager.getImage(NewDataShare.class, "/itmanagerip/Icon/bieutuong/datashare.png"));
		lbImage.setBounds(567, 250, 240, 147);

		Button btnCancel = new Button(shell, SWT.NONE);
		btnCancel.setText("Cancel");
		btnCancel.setImage(SWTResourceManager.getImage(NewDataShare.class, "/itmanagerip/Icon/button/cancel30.png"));
		...
		if (getLanguage() == 0) {
			...
			shell.setText("Ổ đĩa dùng chung mới");
			lbSothe.setText("Số Thẻ");
			lbhoten.setText("Họ Tên");
			lbDonvi.setText("Đơn Vị");
			lbIP.setText("IP");
					...
					try {
						...
						try {
							String insert = "INSERT INTO DataShare( SoThe ,ServerName ,DataShareName ,UserName ,Passwd ,Quyen ,NgayCapNhat,UserUpdate ) VALUES  ( '"
									+ textSothe.getText() + "' ,N'" + textServername.getText() + "' ,N'"
									+ textDatasharename.getText() + "' ,'" + textUsername.getText() + "' ,'"
									+ textPassword.getText() + "' ,'" + comboPermissions.getText() + "' ,GETDATE(),'"
									+ userlogin + "')";
