...
public class NewInternet {
	...
	public static void main(String[] args) {
		try {
			NewInternet window = new NewInternet();
			window.open();
			System.exit(0);
		} catch (Exception e) {
			e.printStackTrace();
	...
	protected void createContents() {
		...
		shell.setText("New Internet");
		shell.setImage(SWTResourceManager.getImage(NewInternet.class, "/itmanagerip/Icon/IP64.png"));
		...
		btnSave.setImage(SWTResourceManager.getImage(NewInternet.class, "/itmanagerip/Icon/button/save 30.png"));
		...
		btnCancel.setImage(SWTResourceManager.getImage(NewInternet.class, "/itmanagerip/Icon/button/cancel30.png"));
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (!textSothe.getText().isEmpty() && !textHoten.getText().isEmpty() && !textIP.getText().isEmpty()
					...
					try {
						...
						try {
							String insert = "INSERT INTO Internet( SoThe ,Website ,NgayDeNghi ,NgayCapNhat,UserUpdate ) VALUES  ( '"
									+ textSothe.getText() + "' ,N'" + textWebsite.getText() + "' ,'" + ngaydenghi
									+ "' ,GETDATE(),'" + userlogin + "' )";
