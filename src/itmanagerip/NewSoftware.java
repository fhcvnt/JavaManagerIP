...
public class NewSoftware {
	...
	public static void main(String[] args) {
		try {
			NewSoftware window = new NewSoftware();
			window.open();
			System.exit(0);
		} catch (Exception e) {
			e.printStackTrace();
	...
	protected void createContents() {
		...
		shell.setText("New Software");
		shell.setImage(SWTResourceManager.getImage(NewSoftware.class, "/itmanagerip/Icon/IP64.png"));
		...
		btnSave.setImage(SWTResourceManager.getImage(NewSoftware.class, "/itmanagerip/Icon/button/save 30.png"));
		...
		btnSave.setBounds(853, 84, 130, 37);
		...
		lbImage.setBackground(
				SWTResourceManager.getImage(NewSoftware.class, "/itmanagerip/Icon/bieutuong/readbook290.png"));
		lbImage.setBounds(869, 160, 290, 324);

		Button btnCancel = new Button(shell, SWT.NONE);
		btnCancel.setText("Cancel");
		btnCancel.setImage(SWTResourceManager.getImage(NewSoftware.class, "/itmanagerip/Icon/button/cancel30.png"));
		...
		btnCancel.setBounds(989, 84, 136, 37);
		...
		datetimeNgaydenghi.setBounds(605, 84, 171, 35);
		...
		lbNgaydenghi.setBounds(339, 84, 246, 35);

		// Gán ngôn ngữ
		if (getLanguage() == 0) {
			// Tieng Viet

			shell.setText("Phần mềm mới");
			lbSothe.setText("Số Thẻ");
			lbhoten.setText("Họ Tên");
			lbDonvi.setText("Đơn Vị");
			lbIP.setText("IP");
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (!textSothe.getText().isEmpty() && !textHoten.getText().isEmpty() && !textIP.getText().isEmpty()
					...
					try {
						...
						try {
							String insert = "INSERT INTO Software( SoThe ,SoftName ,NgayDeNghi ,NgayCapNhat,UserUpdate ) VALUES  ( '"
									+ textSothe.getText() + "' ,N'" + textSoftware.getText() + "' ,'" + ngaydenghi
									+ "' ,GETDATE(),'" + userlogin + "' )";
					...
					if (textSothe.getText().isEmpty()) {
						...
						if (language == 0) {
							thongbao.setText("Thông báo lỗi");
							thongbao.setMessage("Phần mềm rỗng!");
						} else {
							thongbao.setText("Notice error");
							thongbao.setMessage("Software is empty!");
						}
						thongbao.open();
					}
				}
